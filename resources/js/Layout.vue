    ...
    <div class="page">
        ...
        <div class="container-fluid">
            ...
            <ul class="navbar-nav pt-lg-3">
                ...
                <li class="nav-item">
                    <Link class="nav-link d-flex align-items-center" href="/serahterima">
                        <font-awesome-icon :icon="['far', 'hand']" 
                        fixed-width
                        style="font-size: 18px;"
                        class="menu-icon me-2"/>
                        <span class="nav-link-title"> Serah Terima </span>
                    </Link>
                </li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <font-awesome-icon :icon="['far', 'arrow-alt-circle-right']" 
                        ...
                        style="font-size: 18px;"
                        class="menu-icon me-2"/>
                        <span class="nav-link-title"> Claim Issue </span>
                    </a>
                    <div class="dropdown-menu">
                ...
                <li class="nav-item dropdown">
                    ...
                    <font-awesome-icon :icon="['far', 'file-archive']" 
                        ...
                        style="font-size: 18px;"
                        class="menu-icon me-2"/>
                        <span class="nav-link-title"> BA Tolakan </span>
                    </a>
                    <div class="dropdown-menu">
                        <a class="dropdown-item" href="#"> Monitoring </a>
                        <a class="dropdown-item" href="#"> Laporan </a>
                ...
                <li class="nav-item dropdown">
                    <a
                        ...
                        aria-expanded="false"
                    >
                    <font-awesome-icon :icon="['far', 'file-clipboard']" 
                        fixed-width
                        style="font-size: 18px;"
                        class="menu-icon me-2"/>
                ...
                <li class="nav-item dropdown">
                    ...
                    <font-awesome-icon :icon="['far', 'pen-to-square']" 
                        ...
                        style="font-size: 18px;"
                        class="menu-icon me-2"/>                    
                        <span class="nav-link-title"> Izin </span>
                    </a>
                    <div class="dropdown-menu">
                        <a class="dropdown-item" href="#"> Kelola Izin </a>
                        <a class="dropdown-item" href="#"> Laporan </a>
                    </div>
                </li>
                <li class="nav-item dropdown">
                    ...
                    <font-awesome-icon :icon="['far', 'building']" 
                        ...
                        style="font-size: 18px;"
                        class="menu-icon me-2"/>
                        <span class="nav-link-title"> PP Cabang </span>
                    </a>
                    <div class="dropdown-menu">
                        <a class="dropdown-item" href="#"> Buat PP </a>
                        <a class="dropdown-item" href="#"> Data PP </a>
                    </div>
                </li>
                <li class="nav-item dropdown">
                    <a
        ...
        <div class="container-xl">
            ...
            <div class="d-none d-md-flex">
                ...
                <a href="?theme=dark" class="nav-link px-0 hide-theme-dark" title="Enable dark mode" data-bs-toggle="tooltip" data-bs-placement="bottom">
                    <!-- Download SVG icon from http://tabler.io/icons/icon/moon -->
                    <font-awesome-icon :icon="['far', 'moon']" style="font-size: 18px;" />
                </a>
                <a href="?theme=light" class="nav-link px-0 hide-theme-light" title="Enable light mode" data-bs-toggle="tooltip" data-bs-placement="bottom">
                    <!-- Download SVG icon from http://tabler.io/icons/icon/sun -->
                    <svg
                ...
                <a
                    ...
                    aria-expanded="false"
                >
                    <font-awesome-icon :icon="['far', 'bell']" style="font-size: 18px;" />
                    <span class="badge bg-red"></span>
                </a>
                <div class="dropdown-menu dropdown-menu-arrow dropdown-menu-end dropdown-menu-card">
                    <div class="card">
            ...
            <ul class="navbar-nav">
                ...
                >
                    ...
                    <span class="nav-link-title"> <font-awesome-icon :icon="['far', 'user']" /> Interface </span>
                </a>
                <div class="dropdown-menu">
