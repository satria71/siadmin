        ...
        <div class="row align-items-center g-4">
          <div class="col-lg">
            <div class="container-tight">
                  ...
                  <div class="card-body">
                    <h2 class="h2 text-center mb-4">Silahkan Login</h2>
                      <div class="mb-3">
                        ...
                        <input type="text" v-model="form.nik" name="nik" id="nik" class="form-control" placeholder="2015000001" autocomplete="off" />
                        <div v-if="form.errors.nik" class="text-danger">
                          {{ form.errors.nik }}
                        </div>
                      </div>
                      <div class="mb-2">
                        ...
                        <div class="input-group input-group-flat">
                          <input type="password" v-model="form.password" name="password" id="password" class="form-control" placeholder="Password" autocomplete="off" />
              ...
              <div class="text-center text-secondary mt-3">Tidak punya akun? <a href="./sign-up.html" tabindex="-1">Hubungi Admin</a></div>
            </div>
          </div>
